...
module system_axo_axi
  ...
  wire [31:0]ANDXOR_0_BRAM_IFACE_ADDR;
  wire ANDXOR_0_BRAM_IFACE_CLK;
  wire [31:0]ANDXOR_0_BRAM_IFACE_DIN;
  wire [31:0]ANDXOR_0_BRAM_IFACE_DOUT;
  wire ANDXOR_0_BRAM_IFACE_EN;
  wire ANDXOR_0_BRAM_IFACE_RST;
  wire ANDXOR_0_BRAM_IFACE_WE;
  ...
  system_axo_axi_ANDXOR_0_0 ANDXOR_0
       (.AddressOut(ANDXOR_0_BRAM_IFACE_ADDR),
        ...
        .BRAM_RESET(ANDXOR_0_BRAM_IFACE_RST),
        .DataOut(ANDXOR_0_BRAM_IFACE_DIN),
        .DataOutWrite(ANDXOR_0_BRAM_IFACE_WE),
        .ReadData(ANDXOR_0_BRAM_IFACE_DOUT),
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > system_axo_axi axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  system_axo_axi_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  system_axo_axi_axi_bram_ctrl_0_bram_2 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(ANDXOR_0_BRAM_IFACE_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(ANDXOR_0_BRAM_IFACE_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(ANDXOR_0_BRAM_IFACE_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(ANDXOR_0_BRAM_IFACE_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(ANDXOR_0_BRAM_IFACE_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(ANDXOR_0_BRAM_IFACE_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web({ANDXOR_0_BRAM_IFACE_WE,ANDXOR_0_BRAM_IFACE_WE,ANDXOR_0_BRAM_IFACE_WE,ANDXOR_0_BRAM_IFACE_WE}));
  system_axo_axi_axi_smc_1 axi_smc
  ...
  (* BMM_INFO_PROCESSOR = "arm > system_axo_axi axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  system_axo_axi_processing_system7_0_0 processing_system7_0
  ...
  system_axo_axi_rst_ps7_0_50M_1 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
