...
HD_PWD='H:/dev/CSASA/bch_fpga_2/bch_fpga_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axo_axi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source system_axo_axi_wrapper.tcl -notrace
