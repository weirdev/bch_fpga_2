...
set rc [catch {
  ...
  add_files -quiet H:/dev/CSASA/vivaldo_starter/bram_designed_memory_speedtested_working/bram_designed_memory_speedtested_working.runs/synth_1/System_wrapper.dcp
