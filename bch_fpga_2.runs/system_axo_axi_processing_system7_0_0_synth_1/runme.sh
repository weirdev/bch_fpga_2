...
HD_PWD='H:/dev/CSASA/bch_fpga_2/bch_fpga_2.runs/system_axo_axi_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axo_axi_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axo_axi_processing_system7_0_0.tcl
