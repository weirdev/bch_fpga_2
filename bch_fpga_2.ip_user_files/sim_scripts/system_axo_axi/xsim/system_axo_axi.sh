...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib axi_infrastructure_v1_1_0 smartconnect_v1_0 axi_protocol_checker_v2_0_0 axi_vip_v1_1_0 processing_system7_vip_v1_0_2 xlconstant_v1_1_3 lib_cdc_v1_0_2 proc_sys_reset_v5_0_12)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb system_axo_axi.wdb xsim.dir)
